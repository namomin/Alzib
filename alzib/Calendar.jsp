...
<div id="eventForm" style="display: none;" class="form">
    ...
    <form action="CalendarResult.jsp" method="post">
	 ...
	 <h2>근무일 일정 삭제</h2>
        ...
        %>
			...
			<div>일정을 지우고 싶은 근무지를 선택하고 삭제를 누르시면 삭제 됩니다</div>
    ...
    <div id="bulkForm" style="display: none;" class="form">
        ...
        <label for="bulkCSchedule">근무지:</label>
        ...
        <label for="bulkSelectedDays">요일:</label><br>
	...
	<div id="placeForm" style="display: none;" class="form">
        ...
        %>
			...
			<div>근무지를 삭제하면 해당 근무지 일정도 삭제 됩니다</div>
            <input type="submit" value="삭제">
        </form>
    </div>
...
<center>
	...
	<button onclick="showEventForm()">근무일 추가/삭제</button>
