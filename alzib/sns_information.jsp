			...
			<div class="search_wrap">
				<table>
					...
					<th id="th_search">
						...
						<input type="button" id="button" value="search" onclick="search('information')">
					</th>
				</table>
			</div>
                ...
                <table width="700" border="0" cellspacing="0" cellpadding="5">
                    ...
                    <tr>
                        <td colspan="5">
                            <div align="center">
                                <%-- 처음 페이지로 이동 --%>
                                <a href="sns_information.jsp?Category=<%=Category%>&group_index=0">
                                ...
                                %>
                                            <a href="sns_information.jsp?Category=<%=Category%>&group_index=<%= j %>"><%= j + 1 %></a>
                                <%
                                        }
                                    }
                                %>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <%-- 마지막 페이지로 이동 --%>
                                <a href="sns_information.jsp?Category=<%=Category%>&group_index=<%= totalPage - 1 %>">
