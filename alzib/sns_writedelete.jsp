...
<div>
  <div class="modal-content">
    <p><h3><font color="#0047A9">[ <%=Title%> ]</font></h3>해당 게시글을 삭제하시겠습니까?</p>
    <a href="sns_writedeleteResult.jsp?SId=<%=SId%>"><button class="btn btn-yes">삭제</button></a>
    <a href="sns_mywrite.jsp"><button class="btn btn-no">취소</button></a>
  </div>
</div>
</center>
