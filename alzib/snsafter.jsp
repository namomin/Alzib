...
ResultSet rs = null;
int currentPage = 1;
int totalPage = 1; // totalPage 변수 추가
            ...
            <div class="category">
                <table>
                    <tr>
                        ...
                        <td id="present_category"><a href="snsafter.jsp?Category=after"><font color="white">후기</font></a></td>
                    </tr>
                </table>
            </div>
...
<div class="page">
        <%-- 처음 페이지로 이동 --%>
        <% if (currentPage > 1) { %>
            <a href="snsafter.jsp?group_index=0&Category=<%=Category%>">
                < &nbsp;
            </a>
        <% } %>
        ...
        %>
            <a href="snsafter.jsp?group_index=<%= (j-1) %>&Category=<%=Category%>"><%= j %></a> &nbsp;
        <%
                }
            }
        %>
        ...
        <% if (currentPage < totalPage) { %>
            <a href="snsafter.jsp?group_index=<%= (totalPage-1) %>&Category=<%=Category%>">
                >
            </a>
        <% } %>
    </div>
        ...
        <div class="right_wrap">
            <div class="search">
                <input type="text" id="search_bar" placeholder="검색어를 입력하세요" onkeypress="onKeyPress(event)"><input type="button" id="search_button" onclick="search('<%=Category%>')">
            </div>
            <div class="write">
