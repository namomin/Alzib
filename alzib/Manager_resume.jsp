...
<script>
    function search() {
        ...
        window.location.href = "Manager_SRresume.jsp?keyword=" + encodeURIComponent(keyword);
    }
...
<%
        ...
        try {
            ...
            String sql = "SELECT * FROM resume ORDER BY RId DESC";
...
<div class="wrap">
	...
	<div class="header_nav">
		<table>
			<tr>
				<td><a href="Manager_post.jsp"><h3>공고</h3></a></td>
                <td id="choice"><a href="Manager_resume.jsp"><h3>이력서</h3></a></td>
            </tr>
        </table>

			<form method="get" action="Manager_SRresume.jsp">

				<select name="field" id="field">
					<option value="AId">작성자</option>
					<option value="RId">이력서 번호</option>
...
%>				
				<tr>
					...
					<td><a href="Manager_resdelete.jsp?SId=<%=RId%>"><button>삭제</button></a></td>
				</tr>
<%
	}
%>	
