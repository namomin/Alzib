...
<body onload="initMap()">
<form name="post" method="post" action="postmapResult.jsp" >
<div class="wrap">
...
-->	
		...
		<div class="content">
			...
			<div class="sub_content">
				<input type="radio" name="Type" value="알바"  checked> 알바&nbsp;
		...
		<div class="content">
			...
			<div class="sub_content">
				<input type="radio" name="Period" value="하루" checked> 하루&nbsp;
			...
			<div class="sub_content">
				<input type="radio" name="Pay1" id="timep" value="시급" checked> 시급&nbsp;
...
<center>
		<div id="map" style="height: 400px; width: 100%; margin-bottom: 15px; border:2px solid #689ADE; border-radius: 2px; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1);"></div>
	
        <input id="address" type="textbox" placeholder="주소를 입력하세요"> &nbsp;
        <input type="button" value="가게위치저장" onclick="geocodeAddress()" id="msavebutton">
        <input type="hidden" id="x" name="x">
        <input type="hidden" id="y" name="y">
</center>	
		<br><br>
		<div id="button">
			<input type="submit" value="등록 완료"></a>
		</div>
