            ...
            <div class="category">
                <table>
                    <tr>
                        ...
                        <td id="present_category"><a href="snsq.jsp?Category=q"><font color="white">질문</font></a></td>
...
%>
			...
			<%-- 처음 페이지로 이동 --%>
			<% if (list_index > 0) { %>
				<a href="snsq.jsp?group_index=<%=list_index - 1 %>">
					< &nbsp;
				</a>
			<% } %>
			...
			%>
				<a href="snsq.jsp?group_index=<%= j - 1 %>"><%= j %></a> &nbsp;
			<%
					}
				}
			%>
        ...
        <div class="right_wrap">
            <div class="search">
                <input type="text" id="search_bar" placeholder="검색어를 입력하세요" onkeypress="onKeyPress(event)"><input type="button" id="search_button" onclick="search('q')">
            </div>
            <div class="write">
