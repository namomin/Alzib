...
<body>
    ...
    try {
        ...
        // SQL 쿼리 작성
        String query = "INSERT INTO Post (BId, BStore, BName, BAddress, BPhone, BEmail, Title, Category, Type, Personnel, Sex, Age, Ability, Preferential, Period, Day, Time, Pay, Welfare, Etc, Wage) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
