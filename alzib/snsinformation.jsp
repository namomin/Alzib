            ...
            <div class="category">
                <table>
                    <tr>
						...
						<td id="present_category"><a href="snsinformation.jsp?Category=information"><font color="white">알바꿀팁</font></a></td>
...
%>
			...
			<div class="page">
				<%-- 처음 페이지로 이동 --%>
				<% if (list_index > 0) { %>
					<a href="snsinformation.jsp?group_index=<%=list_index - 1 %>">
						< &nbsp;
					</a>
				<% } %>
				...
				%>
					<a href="snsinformation.jsp?group_index=<%= j - 1 %>"><%= j %></a> &nbsp;
				<%
						}
					}
				%>
        ...
        <div class="right_wrap">
            <div class="search">
                <input type="text" id="search_bar" placeholder="검색어를 입력하세요" onkeypress="onKeyPress(event)"><input type="button" id="search_button" onclick="search('information')">
            </div>
            <div class="write">
