...
<header>
	<div id="logo">
		<a href="index_alba.jsp"><img src="images/logo.png" alt="로고 이미지"></a>
	</div>
	<table align="center">
        <th>
	...
	<div id="login">
		<div id="member">
			<font color="#0047A9"><b><%=myid%></b></font> 알바님 환영합니다!
		</div>
	...
	<nav>
		...
		<li> 
			<a href="Calendar_alba.jsp" target="index"><p>편의 기능</p></a>
			<ul>
				<li><a href="Calendar_alba.jsp" target="index">근무시간표</a></li>
				<li><a href="doc_contract.html" target="index">문서양식</a></li>	
			</ul>
		</li>
		<li> 
			<a href="mypageAlba.jsp" target="index"><p>구직 관리</p></a>
		</li>
		</ul>
	</nav>
</header>	
