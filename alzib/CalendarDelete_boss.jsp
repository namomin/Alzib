...
<%
    ...
    String placeNames = request.getParameter("deleteC");
	String selectedDate = request.getParameter("selectedDate2");
	...
	//out.println("<p>selectedDate: " + selectedDate + "</p>");
    ...
    try {
        ...
        String deleteEventsQuery = "DELETE FROM Calendar WHERE CId = ? AND CSchedule = ? AND CCalendar = ?";
        ...
        out.println("<script>");
        out.println("alert('해당 일정이 성공적으로 삭제되었습니다.');");
