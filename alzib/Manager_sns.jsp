...
<div class="wrap">
	...
	<div class="header_nav">
		<table>
			...
			<form method="get" action="Manager_SRsnsmain.jsp">
	...
	<div class="category">
		<table>
			<tr>
				<td id="present_category"><a href="Manager_sns.jsp"><font color="white">모든글</font></a></td>
				...
				<td><a href="Manager_snsq.jsp?Category=q">질문</a></td>
